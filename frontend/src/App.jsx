    ...
    return (
        <Router future={{ v7_relativeSplatPath: true }}>
            <div className="min-h-screen bg-[#0f172a] text-white selection:bg-blue-500/30">
                ...
                <Routes>
                    <Route path="/" element={(user?.role === 'admin' || user?.role === 'super_admin') ? <AdminDashboard user={user} onProviderApproved={fetchProviders} /> : <Home providers={providers} onSearch={fetchProviders} />} />
                    ...
                    <Route path="/admin" element={(user?.role === 'admin' || user?.role === 'super_admin') ? <AdminDashboard user={user} onProviderApproved={fetchProviders} /> : <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
