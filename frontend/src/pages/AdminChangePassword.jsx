...
const AdminChangePassword = ({ user }) => {
    ...
    return (
        <div className="max-w-xl mx-auto px-4 py-8">
            <header className="mb-10">
                <Link to="/admin/settings" className="inline-flex items-center gap-2 text-slate-400 hover:text-blue-400 transition-colors text-xs font-black uppercase tracking-widest mb-6">
                    <ArrowLeft size={16} /> Back to Settings
                </Link>
                <h2 className="text-4xl font-black mb-2 tracking-tight">Security <span className="text-blue-400">Settings</span></h2>
                <p className="text-slate-400 font-medium italic">Update your administrative password</p>
            </header>
            ...
            <div className="glass-panel p-8 relative overflow-hidden">
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-400 font-medium">Protect your {user?.role === 'super_admin' ? 'Super Administrator' : 'Administrator'} account</p>
                    </div>
                </div>
                ...
                <form onSubmit={handlePasswordUpdate} className="space-y-6 max-w-md">
                    ...
                    >
                        {passwordLoading ? 'Updating System...' : <><Save size={18} /> Confirm Password Change</>}
                    </button>
                </form>
            </div>
        </div>
