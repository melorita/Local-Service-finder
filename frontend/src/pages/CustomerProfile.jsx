    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12">
            <header className="mb-10">
                <h2 className="text-4xl font-black mb-2 tracking-tight">Profile <span className="text-blue-400">Settings</span></h2>
                <p className="text-slate-400 font-medium italic">Update your personal information and contact details</p>
            </header>
                ...
                <div className="space-y-6">
                    <div className="glass-panel p-6 border-l-4 border-l-blue-500">
                        <div className="flex gap-4">
                            <ShoppingBag className="text-blue-400 shrink-0" size={24} />
                            <div>
                                <h4 className="font-black text-sm uppercase tracking-widest mb-1 text-white">Member Status</h4>
                                <p className="text-xs text-slate-400 font-bold uppercase tracking-tighter">Verified Customer</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 items-start p-4 bg-amber-500/5 rounded-2xl border border-amber-500/10">
                        ...
                        <p className="text-[10px] text-slate-500 font-medium">Changing your email will affect your login credentials and may require a new session.</p>
                    </div>
                </div>
            </div>
        </div>
