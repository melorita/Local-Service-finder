    ...
    return (
        <Router>
            <div className="min-h-screen bg-[#0f172a] text-white selection:bg-blue-500/30">
                ...
                <Routes>
                    <Route path="/" element={<Home providers={providers} onSearch={fetchProviders} />} />
                    ...
                    <Route path="/admin" element={user?.role === 'admin' ? <AdminDashboard /> : <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
